        ...
        <form action="{{ route('admin.book.update', $book) }}" method="POST" enctype="multipart/form-data">
            ...
            <div id="tab-content-1" class="input-container">
                <div class="input-group lg:col-span-2">
                    ...
                    <x-input id="title" type="text" :disabled="false" name="title" value="{{ $book->title }}"
                        placeholder="Enter book title..."></x-input>
                </div>
                <div class="input-group">
                    <x-label for="isbn">isbn</x-label>
                    <x-input id="isbn" type="text" :disabled="false" name="isbn" value="{{ $book->isbn }}"
                        placeholder="Enter book isbn..."></x-input>
                </div>
                <div class="input-group">
                    <x-label for="author">author</x-label>
                    <x-input id="author" type="text" :disabled="false" name="author" value="{{ $book->author }}"
                ...
                <div class="input-group">
                    ...
                    <x-input id="qty" type="number" :disabled="false" name="qty" value="{{ $book->qty }}"
