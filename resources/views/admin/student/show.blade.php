    ...
    <div class="box-dashboard">
        ...
        <div id="tab-content-1" class="input-container">
                <div class="input-group">
                    ...
                    <x-input id="name" type="text" :disabled="false" readonly value="{{ $student->full_name }}" name="full_name"
                        placeholder="Enter student full name..."></x-input>
                </div>
                <div class="input-group">
                    <x-label for="username">Username</x-label>
                    <x-input id="username" type="text" :disabled="false" readonly value="{{ $student->username }}" name="username"
                        placeholder="Enter student username..."></x-input>
                </div>
                <div class="input-group">
                    <x-label for="email">Email</x-label>
                    <x-input id="email" type="email" :disabled="false" readonly value="{{ $student->email }}" name="email"
                        placeholder="Enter student email..."></x-input>
                </div>
                <div class="input-group">
                    <x-label for="password">Password</x-label>
                    <x-input id="password" type="password" :disabled="false" readonly value="{{ $student->password }}" name="password"
