    ...
    <div class="box-dashboard">
        <div class="text-sm font-medium text-center text-inactive-color border-b border-border-color  mb-5">
            <ul class="flex flex-wrap -mb-px">
                ...
                @if (
                    $event_registration->status === 'finished' &&
                        $event_registration->payment_proof !== 'images/regist/' &&
                        $event_registration->payment_status === 'finished')
                    <li class="me-2">
                        <button onclick="showTab(3)" id="tab-button-2" class="tab tab-inactive">
        ...
        <form action="{{ route('event-registration.update', $event_registration->id) }}" method="POST"
            ...
            <div id="tab-content-1" class="input-container">
                ...
                <div class="input-group">
                    ...
                    <x-input id="date" type="date" :disabled="false" name="date"
            ...
            <div id="tab-content-2" class="input-container !hidden">
                ...
                <div class="input-group">
                    ...
                    <x-input id="payment_proof" type="file" :disabled="false" :required="false" name="payment_proof"
                        onchange="previewImage(event)" value="{{ $event_registration->code }}"
            ...
            <div id="tab-content-3" class="input-container !hidden">
                <div class="input-group">
                    <x-label for="payment_status">Attendance QR</x-label>
                    <img class="w-1/2"
                        src="data:image/png;base64,{{ DNS2D::getBarcodePNG('http://127.0.0.1:8000/admin/attendance/' . $event_registration->id . '/create', 'QRCODE') }}"
                        alt="qrcode" />
                </div>
            </div>
